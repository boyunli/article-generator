package top.pydream.generator.utils;
...
public class Synonyms {
	...
	private static void init() {
		if ((new File("./hashtable.ser")).exists())
			...
			ExcelOperator operator = new ExcelOperator("d:/idea_workspace/00/article-generator/src/main/java/top/pydream/generator/utils/synonyms.xls");
			...
			serializableHashtable.store("d:/idea_workspace/00/article-generator/src/main/java/top/pydream/generator/utils/hashtable.ser");
